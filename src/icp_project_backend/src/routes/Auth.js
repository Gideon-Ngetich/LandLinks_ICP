...
router.post("/signup", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, existingUser, hashedPassword, newUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                newUser = new Users_1.default({ email: email, password: hashedPassword });
            ...
            case 4:
                error_1 = _b.sent();
                console.error("Failed to sign up user:", error_1);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                token = jwt.sign({ userId: user._id }, config_1.default.jwtSecret, {
                    expiresIn: "1h",
                });
            ...
            case 3:
                error_2 = _b.sent();
                console.error("Failed to log in user:", error_2);
